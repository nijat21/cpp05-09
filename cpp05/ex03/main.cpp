...
int main() {
	...
	std::cout << "===============================================================================" << std::endl;
	AForm* s = i.makeForm("ShrubberyCreationForm","home");
	std::cout << *s << std::endl;
	std::cout << std::endl;

	AForm* r = i.makeForm("RobotomyRequestForm","electronic thumb");
	std::cout << *r << std::endl;
	std::cout << std::endl;
	
	AForm* p = i.makeForm("PresidentialPardonForm","travelers");
	std::cout << *p << std::endl;
	std::cout << std::endl;
